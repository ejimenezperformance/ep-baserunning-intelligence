...
![Chapter 1: speed vs. baserunning value](report/chart_baserunning_comparativo_en.png)
...
![Chapter 2: run phases vs. each skill](report/chart_baserunning_ch2_phases_en.png)
...
![Chapter 3: speed vs. value by position](report/chart_baserunning_ch3_position_en.png)
...
![Chapter 4: decision, not speed](report/chart_baserunning_ch4_decision_en.png)


### The honest read

**CONFIRMED (in this data):**
- Speed explains some of **who attempts** the extra base (R² 0.28, a
  moderate effect) and very little of **who is safe when attempting**
  (R² 0.03). The link with per-attempt success is not zero (r = 0.21,
  p < 0.001) but it is small.
...
- Speed alone does not tell you who makes good decisions, and decision
  quality probably has to be measured separately. Note: this data compares
  runners with different speeds; it does not measure what happens when
  speed is trained.
...
python3 model/make_charts_en.py                # English versions of the chapter 1-3 charts
```
