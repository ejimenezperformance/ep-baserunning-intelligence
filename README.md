...
- La velocidad explica algo de **quién intenta** la base extra (R² 0.28, un
  efecto moderado) y muy poco de **quién sale safe cuando intenta** (R² 0.03).
  La relación con el éxito por intento no es cero (r = 0.21, p < 0.001), pero
  es pequeña.
...
- La velocidad sola no dice quién toma buenas decisiones, y la calidad de
  decisión probablemente hay que medirla aparte. Ojo: estos datos comparan
  corredores con distinta velocidad; no miden qué pasa al entrenar velocidad.
